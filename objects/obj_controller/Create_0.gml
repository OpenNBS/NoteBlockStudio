...
var copy_data = !directory_exists(data_directory)
			 ...
			 || (os_type = os_linux && !file_exists(data_directory + "changelog.txt"))
			 || (os_type = os_linux && !file_exists(data_directory + "credits.txt"))
			 || (os_type = os_linux && !file_exists(data_directory + "extranotes.txt"))
			 || (os_type = os_linux && !file_exists(data_directory + "instrumenttextures.txt"))
